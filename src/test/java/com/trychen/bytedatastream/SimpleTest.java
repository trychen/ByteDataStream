...
public class SimpleTest {
    private final SimpleData begin = new SimpleData(1651, 165161868L, 0.15161, 1.165F, (short)5, (byte) 0x2, true, new byte[]{0x1, 0x2, 0x4},  "Hello World", new Date(), SimpleData.Type.HELLO, UUID.randomUUID(), Arrays.asList(1, 2, 3));
